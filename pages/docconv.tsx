...
const docFormats = [
    "CSV", "DOC", "DOCX", "PDF", "DOT", "DOTX", "HTML", "LOG", "MHTML", "ODT", "POTX",
    "PPS", "PPSX", "PPT", "PPTX", "PUB", "RTF", "TEX", "TEXT", "TXT", "VSD", "VSDX", "VST", "VSTX", "WPD", "WRI",
    "XLS", "XLSB", "XLSX", "XLT", "XLTX", "XML"
];

const DocConverter = () => {

    const data: RegularPage = converter.docConverter;
    const { title, description, meta_title } = data.frontmatter;

    const [sourceFormat, setSourceFormat] = useState("DOC");
